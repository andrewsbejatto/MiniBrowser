...
begin
  FrmMiniBrowser.Chromium1.Find(FindTextEdt.Text, True, False, FFirstNext);
  FFirstNext := True;
end;

procedure TFindFrm.FindPrevBtnClick(Sender: TObject);
begin
  FrmMiniBrowser.Chromium1.Find(FindTextEdt.Text, False, False, FFirstNext);
  FFirstNext := True;
end;
...
begin
  FrmMiniBrowser.Chromium1.StopFinding(True);
end;
